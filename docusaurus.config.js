...
const config = {
  title: 'eSchool Documentation',
  tagline: 'Comprehensive documentation for eSchool covering installation, setup, features, and support.',
  ...
  projectName: 'eSchool-Doc', // Your repository name
  trailingSlash: true,
